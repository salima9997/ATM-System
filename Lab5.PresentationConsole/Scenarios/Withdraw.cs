...
public class Withdraw(IAccountService accountService) : Scenario(accountService)
{
    public override string ScenarioName() => "Withdraw";
    ...
    public override void Run()
    {
        ...
        GetAccountService().Withdraw(username, amount);
